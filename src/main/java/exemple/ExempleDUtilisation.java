...
public class ExempleDUtilisation {
    ...
    public void exemple() {
        ...
        sce.ajouteEffet(EffetEnum.Apparition, 2, "bonjour");
        sce.ajouteEffet(EffetEnum.Rotation, 1, "bonjour");
        sce.ajouteEffet(EffetEnum.Zoom, 1, "bonjour");        
        sce.executeSenario();
        sce.monBandeau.close();
    }
